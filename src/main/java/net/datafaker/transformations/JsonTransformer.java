...
public class JsonTransformer<IN> implements Transformer<IN, CharSequence> {
    ...
    private static void value2String(Object value, StringBuilder sb) {
        if (value == null) {
            sb.append("null");
        } else if (value instanceof Integer || value instanceof Long || value instanceof Short || value instanceof BigInteger || value instanceof Boolean || value instanceof Double || value instanceof BigDecimal) {
            sb.append(value);
        } else {
    ...
    private static Map<Character, String> createEscapeMap() {
        return Map.ofEntries(Map.entry('\\', "\\\\"), Map.entry('\"', "\\\""), Map.entry('\b', "\\b"), Map.entry('\f', "\\f"), Map.entry('\n', "\\n"), Map.entry('\r', "\\r"), Map.entry('\t', "\\t"), Map.entry('/', "\\/"), Map.entry('\u0000', "\\u0000"), Map.entry('\u0001', "\\u0001"), Map.entry('\u0002', "\\u0002"), Map.entry('\u0003', "\\u0003"), Map.entry('\u0004', "\\u0004"), Map.entry('\u0005', "\\u0005"), Map.entry('\u0006', "\\u0006"), Map.entry('\u0007', "\\u0007"), // map.put('\u0008', "\\u0008");
        ...
        Map.entry('\u000E', "\\u000E"), Map.entry('\u000F', "\\u000F"), Map.entry('\u0010', "\\u0010"), Map.entry('\u0011', "\\u0011"), Map.entry('\u0012', "\\u0012"), Map.entry('\u0013', "\\u0013"), Map.entry('\u0014', "\\u0014"), Map.entry('\u0015', "\\u0015"), Map.entry('\u0016', "\\u0016"), Map.entry('\u0017', "\\u0017"), Map.entry('\u0018', "\\u0018"), Map.entry('\u0019', "\\u0019"), Map.entry('\u001A', "\\u001A"), Map.entry('\u001B', "\\u001B"), Map.entry('\u001C', "\\u001C"), Map.entry('\u001D', "\\u001D"), Map.entry('\u001E', "\\u001E"), Map.entry('\u001F', "\\u001F"));
    }
